    ...
    public partial class Form1 : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
           ...
           // rtfReceipt.AppendText(Environment.NewLine);
            rtfReceipt.AppendText("-------------------------------------------------------------" + Environment.NewLine);
            rtfReceipt.AppendText("\t\t" + "Bill Recipt" + Environment.NewLine);
            rtfReceipt.AppendText("-------------------------------------------------------------" + Environment.NewLine);
            ...
            rtfReceipt.AppendText("-------------------------------------------------------------" + Environment.NewLine);
            rtfReceipt.AppendText("Discount \t\t\t" + lblDiscount.Text + Environment.NewLine);
        ...
        { //btnTotal
            ...
            Restaurant eat_in_cafe = new Restaurant(latteeCof, mochaCof, espressoCof, valeCoffee, cappCof, afriCof, miTea, cineseTea,
            ...
            lblDiscount.Text = Convert.ToString(((cakeCosts + drinkCosts + svcCharge) * discount) / 100);
            double totalAftDisc = Convert.ToDouble(lblDiscount.Text);
            lblTotal.Text = Convert.ToString((cakeCosts + drinkCosts + svcCharge) - totalAftDisc);
            ...
            lblDiscount.Text = String.Format("{0:C}", totalAftDisc);
            lblTotal.Text = String.Format("{0:C}", (cakeCosts + drinkCosts + svcCharge) - totalAftDisc);
        }
